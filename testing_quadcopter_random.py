...
model = PPO.load("ppo_quadcopter_rollpitch_random", env=env)
...
plt.plot(time_array, action_values[:,2], color='b', label ='Kp pitch')
plt.plot(time_array, action_values[:,3], color='y', label='Kd pitch')
...
# plt.figure()
# plt.plot(time_array, observation_values[:,0], color='r', label='Roll')
# plt.plot(time_array, observation_values[:,1], color='g', label='Pitch')
...
# plt.figure()
# plt.plot(time_array, observation_values[:,2], color='r', label='Roll Dot')
# plt.plot(time_array, observation_values[:,3], color='g', label='Pitch Dot')
# plt.title('Roll and Pitch Dot over Time')
# plt.xlabel('Time (s)')
# plt.ylabel('Orientation Rate (rad/s)')
# plt.legend()

# plt.figure()
# plt.plot(time_array, observation_values[:,4], color='r', label='wx')
# plt.plot(time_array, observation_values[:,5], color='b', label='wy')
# plt.title('x and y Angular Velocity')
# plt.xlabel('Time(s)')
...
plt.plot(time_array, rpy_dot_values_pi[:, 0], color='r', label='roll dot')
plt.plot(time_array, rpy_dot_values_pi[:, 1], color='g', label='pitch dot')
plt.title('Roll and Pitch Rate over Time')
plt.xlabel('Time(s)')
plt.ylabel('Orientation Rate (rad/s)')
plt.legend()
plt.gca().yaxis.set_major_locator(MultipleLocator(base=0.5))
...
plt.figure()
plt.plot(time_array, pd_controller_error_pi[:, 0], label='Roll Error', color='r')
plt.plot(time_array, pd_controller_error_pi[:, 1], label='Pitch Error', color='g')
...
plt.figure()
plt.plot(time_array, pd_controller_dot_error_pi[:, 0], label='Roll Dot Error', color='r')
plt.plot(time_array, pd_controller_dot_error_pi[:, 1], label='Pitch Dot Error', color='g')
